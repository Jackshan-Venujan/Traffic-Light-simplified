...
\begin{figure}[ht]
    ...
    \end{center}
    \caption{Training and validation loss curves (box loss, classification loss, DFL loss) alongside accuracy metrics (mAP@50, mAP@50-95, Precision, Recall) across 47 training epochs. The red dotted vertical line marks epoch 27, where the best model was saved.}
    \label{fig:curves}
\end{figure}
